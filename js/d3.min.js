d3 = function () {
    ...
    function ot(n, t, e) {
        ...
        var r = nt((.4124564 * n + .3575761 * t + .1804375 * e) / to),
            i = nt((.2126729 * n + .7151522 * t + .072175 * e) / eo),
            u = nt((.0193339 * n + .119192 * t + .9503041 * e) / ro);
    ...
    function Jt(n, t, e, r) {
        var i;
        if (null == n) i = e * $a / 2, r.point(-$a, i), r.point(0, i), r.point($a, i), r.point($a, 0), r.point($a, -i), r.point(0, -i), r.point(-$a, -i), r.point(-$a, 0), r.point(-$a, i);
        else if (Math.abs(n[0] - t[0]) > Wa) {
            var u = (n[0] < t[0] ? 1 : -1) * $a;
        ...
        function e(n) {
            ...
            return {
                ...
                point: function (s, h) {
                    var g, p = [s, h],
                        d = t(s, h),
                        m = o ? d ? 0 : i(s, h) : d ? i(s + (0 > s ? $a : -$a), h) : 0;
                    if (!e && (c = a = d) && n.lineStart(), d !== a && (g = r(e, p), (jt(e, g) || jt(p, g)) && (p[0] += Wa, p[1] += Wa, d = t(p[0], p[1]))), d !== a) f = 0, d ? (n.lineStart(), g = r(p, e), n.point(g[0], g[1])) : (g = r(e, p), n.point(g[0], g[1]), n.lineEnd()), e = g;
                    else if (l && e && o ^ d) {
                        var v;
    ...
    function ge(n) {
        function t(t) {
            ...
            var h, g, p, d, m, v, y, M, x, b, _, w, S, E = {
                point: r,
                lineStart: u,
                lineEnd: o,
                polygonStart: function () {
        ...
        function e(t, i, u, a, o, c, l, f, s, h, g, p, d, m) {
            ...
            if (M > 4 * r && d--) {
                var x = a + h,
                    ...
                    S = Math.asin(_ /= w),
                    E = Math.abs(Math.abs(_) - 1) < Wa ? (u + s) / 2 : Math.atan2(b, x),
                    k = n(E, S),
                    A = k[0],
                    N = k[1],
                    q = A - t,
    ...
    function _r(n, t) {
        var e, r, i, u, a, o = 0,
            ...
            l = [],
            f = [];
        for (n += "", t += "", fc.lastIndex = 0, r = 0; e = fc.exec(t); ++r) e.index && l.push(t.substring(o, c = e.index)), f.push({
            i: l.length,
            x: e[0]
        }), l.push(null), o = fc.lastIndex;
    ...
    function Hr(n, t) {
        var e;
        return arguments.length < 2 && (t = .45), arguments.length ? e = t / (2 * $a) * Math.asin(1 / n) : (n = 1, e = t / 4),
            function (r) {
    ...
    va.bisectLeft = Sa.left, va.bisect = va.bisectRight = Sa.right, va.shuffle = function (n) {
        ...
        for (var n = -1, e = va.min(arguments, t), r = Array(e); ++n < e;)
    ...
    var Aa = /WebKit/.test(xa.navigator.userAgent) ? -1 : 0,
        Na = d;
    try {
    ...
    va.behavior.drag = function () {
        ...
        function t() {
            ...
            function i() {
                o({
                    type: "dragend"
                }), g && (l(), va.event.target === c && s(d, "click")), d.on(null != f ? "touchmove.drag-" + f : "mousemove.drag", null).on(null != f ? "touchend.drag-" + f : "mouseup.drag", null), p()
            }
            var u, a = this,
                o = e.of(a, arguments),
                c = va.event.target,
                f = va.event.touches ? va.event.changedTouches[0].identifier : null,
                h = n(),
                g = 0,
                p = Da(null != f ? "drag-" + f : "drag"),
                d = va.select(xa).on(null != f ? "touchmove.drag-" + f : "mousemove.drag", t).on(null != f ? "touchend.drag-" + f : "mouseup.drag", i, !0);
            r ? (u = r.apply(a, arguments), u = [u.x - h[0], u.y - h[1]]) : u = [0, 0], o({
                type: "dragstart"
            })
        }
    ...
    va.ns = {
        ...
        qualify: function (n) {
            var t = n.indexOf(":"),
                e = n;
            return t >= 0 && (e = n.substring(0, t), n = n.substring(t + 1)), Oa.hasOwnProperty(e) ? {
                space: Oa[e],
                local: n
            } : n
        }
    ...
    va.behavior.zoom = function () {
        ...
        function o() {
            ...
            var r = this,
                ...
                o = va.event.target,
                c = 0,
                f = va.select(xa).on("mousemove.zoom", n).on("mouseup.zoom", e),
                h = t(va.mouse(r)),
                g = Da("zoom")
        }
    ...
    var so = xa[m(xa, "requestAnimationFrame")] || function (n) {
        ...
        go = ",",
        po = [3, 3],
        mo = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(yt);
    ...
    var Ao, No, qo, To, Co, zo, Do, jo, Lo, Ho, Fo, Po = {
            sphere: T,
            point: Lt,
            lineStart: Ft,
            lineEnd: Pt,
    ...
    (va.geo.conicEqualArea = function () {
        ...
        return n.invert = function (n) {
            ...
            var l = u.scale(),
                f = +t[0],
                s = +t[1];
            return e = u.translate(t).clipExtent([[f - .455 * l, s - .238 * l], [f + .455 * l, s + .238 * l]]).stream(c).point, r = a.translate([f - .307 * l, s + .201 * l]).clipExtent([[f - .425 * l + Wa, s + .12 * l + Wa], [f - .214 * l - Wa, s + .234 * l - Wa]]).stream(c).point, i = o.translate([f - .205 * l, s + .212 * l]).clipExtent([[f - .214 * l + Wa, s + .166 * l + Wa], [f - .115 * l - Wa, s + .234 * l - Wa]]).stream(c).point, n
        }, n.scale(1070)
    };
    var Uo, Io, Vo, Xo, Zo, Bo, $o = {
            point: T,
            lineStart: T,
            lineEnd: T,
            polygonStart: function () {
    ...
    va.geo.path = function () {
        ...
        return n.area = function (n) {
            ...
            return Zo = Bo = -(Vo = Xo = 1 / 0), va.geo.stream(n, i(Wo)), [[Vo, Xo], [Zo, Bo]]
        ...
        }, n.majorExtent([[-180, -90 + Wa], [180, 90 - Wa]]).minorExtent([[-180, -80 - Wa], [180, 80 + Wa]])
    ...
    va.geom.hull = function (n) {
        ...
        function t(n) {
            ...
            if (c === Pe && l === Oe) t = n;
                ...
                for (t = Array(f), a = 0; f > a; ++a) t[a] = [+c.call(this, u = n[a], a), +l.call(this, u, a)];
            if (lr(t, function (n) {
                    var t, e, r, i, u, a;
        ...
        return arguments.length ? t(n) : (t.x = function (n) {
            ...
            if (c === Pe && l === Oe) t = n;
                ...
                for (t = Array(f), u = 0; f > u; ++u) t[u] = [+c.call(this, i = n[u], u), +l.call(this, i, u)];
    ...
    var bc = ["#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf"],
        _c = ["#1f77b4", "#aec7e8", "#ff7f0e", "#ffbb78", "#2ca02c", "#98df8a", "#d62728", "#ff9896", "#9467bd", "#c5b0d5", "#8c564b", "#c49c94", "#e377c2", "#f7b6d2", "#7f7f7f", "#c7c7c7", "#bcbd22", "#dbdb8d", "#17becf", "#9edae5"],
        wc = ["#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6"],
        Sc = ["#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9"];
    va.scale.quantile = function () {
        ...
        function n() {
            var n = t.apply(this, arguments),
                ...
                a = r.apply(this, arguments) + Ec,
                o = i.apply(this, arguments) + Ec,
        ...
        return n.innerRadius = function (e) {
            ...
            var n = (t.apply(this, arguments) + e.apply(this, arguments)) / 2,
                u = (r.apply(this, arguments) + i.apply(this, arguments)) / 2 + Ec;
    ...
    va.svg.brush = function () {
        ...
        function i() {
            ...
            function p() {
                var n = i(),
                    u = !1;
                y && (n[0] += y[0], n[1] += y[1]), k || (va.event.altKey ? (v || (v = [(s[0][0] + s[1][0]) / 2, (s[0][1] + s[1][1]) / 2]), A[0] = s[+(n[0] < v[0])][0], A[1] = s[+(n[1] < v[1])][1]) : v = null), S && d(n, o, 0) && (e(_), u = !0), E && d(n, c, 1) && (r(_), u = !0), u && (t(_), b({
                    type: "brush",
                    mode: k ? "move" : "resize"
                }))
            }
            ...
            function m() {
                p(), _.style("pointer-events", "all").selectAll(".resize").style("display", n.empty() ? "none" : null), va.select("body").style("cursor", null), N.on("mousemove.brush", null).on("mouseup.brush", null).on("touchmove.brush", null).on("touchend.brush", null).on("keydown.brush", null).on("keyup.brush", null), b({
                    type: "brushend"
                }), l()
            }
            var v, y, M = this,
                ...
                k = x.classed("extent"),
                A = i(),
                N = va.select(xa).on("mousemove.brush", p).on("mouseup.brush", m).on("touchmove.brush", p).on("touchend.brush", m).on("keydown.brush", f).on("keyup.brush", h);
            if (k) A[0] = s[0][0] - A[0], A[1] = s[0][1] - A[1];
            else if (w) {
                var q = +/w$/.test(w),
                    T = +/^n/.test(w);
    ...
    var Hc = {
        ...
        Fc = [["n", "e", "s", "w", "nw", "ne", "se", "sw"], ["e", "w"], ["n", "s"], []];
    va.time = {};
    var Pc = Date,
        Oc = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
    Cu.prototype = {
        getDate: function () {
    ...
    var Rc = Date.prototype,
        ...
        Uc = "%m/%d/%Y",
        Ic = "%H:%M:%S",
        Vc = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
        Xc = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
        Zc = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
    ...
    var ll = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6],
        fl = [[va.time.second, 1], [va.time.second, 5], [va.time.second, 15], [va.time.second, 30], [va.time.minute, 1], [va.time.minute, 5], [va.time.minute, 15], [va.time.minute, 30], [va.time.hour, 1], [va.time.hour, 3], [va.time.hour, 6], [va.time.hour, 12], [va.time.day, 1], [va.time.day, 2], [va.time.week, 1], [va.time.month, 1], [va.time.month, 3], [va.time.year, 1]],
        sl = [[va.time.format("%Y"), Rt], [va.time.format("%B"), function (n) {
            return n.getMonth()
    ...
    var pl = fl.map(function (n) {
        ...
        dl = [[va.time.format.utc("%Y"), Rt], [va.time.format.utc("%B"), function (n) {
